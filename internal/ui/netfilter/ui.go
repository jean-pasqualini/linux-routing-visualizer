...
import (
	...
	"github.com/jeanpasqualini/linux-routing-visualizer/internal/ui/netfilter/ebtable"
...
func NewNetfilterView() *NetfilterView {
	...
	ebTableView := ebtable.NewEbtableView()

	pages := tab.NewTabPanelSidebar(tview.NewPages())
	pages.AddPage("conntrack", conntrackView, true, true)
